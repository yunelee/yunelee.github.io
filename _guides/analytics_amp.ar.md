...
تم تصميم تحليلات AMP خصوصًا للقياس مرة واحدة وإرسال التقرير إلى كثيرين.
...
انظر أيضًا
[دمج أدوات التحليلات لديك في AMP HTML](https://github.com/ampproject/amphtml/blob/master/extensions/amp-analytics/integrating-analytics.md).
...
(انظر أيضًا [amp-pixel أو amp-analytics](/docs/guides/analytics/analytics_basics.html#use-amp-pixel-or-amp-analytics))؟
