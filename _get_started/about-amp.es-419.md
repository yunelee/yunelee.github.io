...
El **caché de Google AMP** (opcional) proporciona las páginas AMP HTML.
...
El caché de Google AMP es una red de distribución de contenido basada en proxy
...
Al usar el caché de Google AMP, el documento, todos los archivos de JS y todas las imágenes se cargan
