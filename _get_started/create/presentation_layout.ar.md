...
صفحات AMP هي صفحات ويب؛ وأي تحكم في أنماط الصفحة وعناصرها يجري باستخدام خصائص CSS الشائعة. تحكّم في أنماط العناصر باستخدام محدّدات الفئة أو العنصر في ورقة أنماط مضمّنة في `<head>`، والتي تُسمى`<style amp-custom>`:
...
{% include button.html title="المتابعة إلى الخطوة 4" link="/docs/get_started/create/preview_and_validate.html" %}
